...
import { WishListApi, WishListDeleteApi, WishListInsertApi, areaTripDetail } from "../apis/api";
    ...
    const onClickedStar = (e: any) => {
        ...
        if (isLoggedIn !== "true") {
            ...
            if (WishListData === '실패') {
                ...
                // console.log("클릭실패 별생김");
                setStar(false);
            } else {
                WishListDeleteApi(id, contentId);
                // console.log("클릭성공 별없어짐");
                setStar(true);
            }
        }
    };
